...
?>
<header class="shadow-sm header sticky-top pe-4" id="header">
    <div
        ...
        <nav id="navmenu" class="navmenu">
            <ul>
                ...
                <li><a class="d-block d-xl-none"
                        href="<?= $base_path ?>/cse-bca-mca-it-Computer-science-btech-projects-list/">Computer Science
                        CS
                        IT</a></li>
                <li><a class="d-block d-xl-none"
                        href="<?= $base_path ?>/electronics-ece-btech-engineering-projects-list/">Electronics Electrical
                        EC
                        EL</a></li>
                <li><a class="d-block d-xl-none"
